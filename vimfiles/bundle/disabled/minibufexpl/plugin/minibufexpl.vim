...
" AL - check if we want spaces in between tabs
if !exists('g:miniBufExplNumSpaces')
    let g:miniBufExplNumSpaces = 0
endif
...
function! <SID>BuildBufferList(delBufNum, updateBufList)
  ...
  " Given our g:miniBufExplNumSpaces, decide how many spaces will separate our tabs
  if(g:miniBufExplNumSpaces > 0)
      let l:sep = repeat(' ', g:miniBufExplNumSpaces)
  endif    
      ...
      if(getbufvar(l:i, '&buflisted') == 1)
        ...
        if(strlen(l:BufName))
          ...
          if (getbufvar(l:i, '&modifiable') == 1 && BufName != '-MiniBufExplorer-')
            ...
            let l:tab = l:tab . '[' . l:i . ':' . l:shortBufName . ']'
            ...
            " only append our separator after the first item
            if l:cnt > 0
                 let l:fileNames = l:fileNames.l:sep
            endif
